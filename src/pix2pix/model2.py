...
class pix2pix(object):
    def __init__(self, sess, image_size=256, batch_size=1, sample_size=1, output_size=256, load_size=286,
        ...
        self.g_bn_d8_256 = batch_norm(name='g_bn_d8_256')
    ...
    def build_model(self, size, phase):
        ...
        self.fake_B_128, d128 = self.generator_64_to_128(self.real_A_64, d6)
    ...
    def generator_64_to_128(self, image, d6):
    ...
    def sampler_256(self, image, d6, d128, y=None):
        ...
        with tf.variable_scope("generator") as scope:
            scope.reuse_variables()
            return self.g_128_to_256(out_128, d128)
